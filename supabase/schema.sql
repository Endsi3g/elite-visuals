...
-- Note: RLS (Row Level Security) sera activé sur chaque table individuellement
-- Le JWT secret est géré automatiquement par Supabase
...
CREATE INDEX IF NOT EXISTS idx_ai_generations_board_id ON public.ai_generations(board_id);
...
CREATE POLICY "Board editors can insert items"
